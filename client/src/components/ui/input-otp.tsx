  ...
  return (
    <div
      ...
      className={cn(
        ...
        isActive &&
          "z-10 ring-2 ring-violet-300 ring-offset-white dark:ring-slate-300 dark:ring-offset-slate-50",
        className
      )}
      {...props}
    >
      ...
      {hasFakeCaret && (
        <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
          <div className="h-4 w-px animate-caret-blink bg-slate-50 duration-1000 dark:bg-slate-50" />
        </div>
      )}
    </div>
  );
